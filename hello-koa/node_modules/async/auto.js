...
exports.default = function (tasks, concurrency, callback) {
    ...
    function runTask(key, task) {
        ...
        var taskCallback = (0, _onlyOnce2.default)((0, _rest2.default)(function (err, args) {
            runningTasks--;
            if (args.length <= 1)="" {="" args="args[0];" }="" if="" (err)="" var="" saferesults="{};" (0,="" _baseforown2.default)(results,="" function="" (val,="" rkey)="" saferesults[rkey]="val;" });="" saferesults[key]="args;" haserror="true;" listeners="Object.create(null);" callback(err,="" saferesults);="" else="" results[key]="args;" taskcomplete(key);="" }));="" runningtasks++;="" taskfn="task[task.length" -="" 1];="" (task.length=""> 1) {
